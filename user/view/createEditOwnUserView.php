...
if (isset($_SESSION['editOwnUserData'])) {
    $editOwnUserData = $_SESSION['editOwnUserData'];

    $id = $editOwnUserData->getId();
    $loginName = $editOwnUserData->getLoginName();

    unset($_SESSION['editOwnUserData']);
}
?>
...
<head>
    ...
    <title>php-webshop - user/view/createEditOwnUserView.php</title>
</head>
    ...
    <main>
        <form action="../controller/userController.php" method="post">
            <table class="tableForInput">
                <thead>
                    <tr>
                        <th class='tableHeadline' colspan='2'>Benutzer bearbeiten</th>
                    </tr>
                </thead>
                <tbody>
                    <tr hidden>
                    ...
                    <tr>
                        <td></td>
                        <td><button type="submit" name="editOwnUserSubmitButton">OK</button></td>
                    </tr>
                    <tr>
                        <td></td>
